    ...
    <section class="ftco-about d-md-flex bg-light">
        ...
        <div class="one-half ftco-animate">
            ...
            <div class="heading-section ftco-animate">
                ...
                <h3 class="subheading">About Stonks</h3>
                ...
                <div class="offset-lg-1 col-lg-3 d-flex">
                    ...
                    <div class="coach align-items-stretch">
                        ...
                        <div class="text bg-white p-4 ftco-animate">
                            ...
                            <p>Owner of Stonks, Erik is a Human Potential Coach in training under the Bulletproof company. Erik specializes in Bulletproof coaching, from diet to workout programs and mindfulness practices.</p>
